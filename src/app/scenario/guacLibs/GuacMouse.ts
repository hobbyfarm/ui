...
const mouse: any = function (this: any, element: any) {
  /**
   ...
   */
  this.onmousedown = (state: Guacamole.Mouse.State) => {
    return;
  };
  ...
  function mousewheel_handler(e: { deltaY: number; wheelDeltaY: number; wheelDelta: number; deltaMode: number; detail: number; }) {
   ...
   */
  this.setCursor = (canvas: { toDataURL: (arg0: string) => any; }, x: string, y: string) => {
